...
"""
def GetInfo():
    tags = ["Математика", "Геометрия", "8 Класс"]
    jsonInfo = {
...
def DrawOnImage(image,TaskText):
    ImageDrawing = ImageDraw.Draw(image)
    ImageDrawing.polygon([(50,30), (50,200), (350, 200)], outline="black")
    TextTuple = (50,230)
    DrawTextOnImage(ImageDrawing,TextTuple,TaskText,"black", ImageFont.truetype('Roboto-Black.ttf', 7))
    FirstPointTuple = (30,100)
    DrawTextOnImage(ImageDrawing,FirstPointTuple,"a","black",FontBig())
    SecondPointTuple = (170,200)
    DrawTextOnImage(ImageDrawing,SecondPointTuple,"b","black",FontBig())
    ThirdPointTuple = (210,100)
    DrawTextOnImage(ImageDrawing,ThirdPointTuple,"c","black",FontBig())
...
def CreateImage(TaskText):
    taskImage = CreateClearImage()
    DrawOnImage(taskImage,TaskText)
